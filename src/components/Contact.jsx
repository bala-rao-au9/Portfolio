...
function Contact() {
    const {
      ...
      const onSubmit = async  (data) => {
        ...
        try{
            await axios.post("https://getform.io/f/ajjexwea", userInfo);
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center mt-5">
        <form 
            ...
            // action="https://getform.io/f/ajjexwea"
            // method="POST"
            ...
            <div className="flex flex-col mb-4">
                ...
                <input
                    ...
                    className="shadow rounded-lg appearance-none  py-2 px-3 text-gray-700 leading tight focus:out"
                    id="name"
                    name="name"
                    type="text"
